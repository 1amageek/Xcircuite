...
struct XcircuiteSymbolicPlannerPDDLExporterTests {
    @Test func exporterWritesPDDLArtifactsAndAtomMappings() async throws {
        ...
        #expect(result.domainArtifact.digest.hexadecimalValue.isEmpty == false)
        #expect(result.problemArtifact.digest.hexadecimalValue.isEmpty == false)
        #expect(result.exportArtifact.digest.hexadecimalValue.isEmpty == false)
