public struct XcircuiteSymbolicPlannerSolverFamilyBatchCandidateRequest: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            policyID: try container.decodeIfPresent(String.self, forKey: .policyID) ?? "symbolic-planner-solver-qualification-v1",
            ...
            certificateFormat: try container.decodeIfPresent(String.self, forKey: .certificateFormat) ?? "auto",
