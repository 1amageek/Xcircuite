...
extension XcircuiteFlowCLICommand {
    ...
    public static var helpText: String {
        ...
        Usage:
          ...
          xcircuite-flow evaluate-opamp --spec <path> (--cross-artifact-evaluation <path> | --sizing-result <path> | --simulation-metric-report <path> | --simulation-run-summary <path> | --simulation-measurements <path>) [--out <path>] [--project-root <path> --run-id <id> --persist] [--pretty]
