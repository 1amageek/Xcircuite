...
extension XcircuiteFlowCLICommand {
    ...
    public static var helpText: String {
        ...
        Usage:
          ...
          xcircuite-flow evaluate-opamp --spec <path> (--cross-artifact-evaluation <path> | --sizing-result <path>) [--out <path>] [--project-root <path> --run-id <id> --persist] [--pretty]
    ...
    public static var evaluateOpAmpHelpText: String {
        ...
        Evaluates op-amp metrics against an OpAmpSpec and emits pass/fail/missing results with failure classifications and suggested next actions for an external Agent or developer.
        """
    }
